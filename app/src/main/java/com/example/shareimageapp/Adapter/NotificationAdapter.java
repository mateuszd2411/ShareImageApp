...
import com.example.shareimageapp.Model.Notification;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        //clickable to unique notification in recycler view
    ...
    private void getUserInfo(final ImageView imageView, final TextView username, String publisherid){
        //go to "Users" in realtime database to publisher id
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //set publisher info to notification
    ...
    private void getPostImage(final ImageView imageView, final String postid){
        //go to "Posts" in realtime database and get post id
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Posts")
                .child(postid);
        //set post image to notification
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
